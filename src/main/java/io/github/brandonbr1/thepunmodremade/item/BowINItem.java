...
import io.github.brandonbr1.thepunmodremade.procedures.BowINRangedItemUsedProcedure;
import io.github.brandonbr1.thepunmodremade.entity.BowINEntity;

public class BowINItem extends Item {
	public BowINItem() {
		super(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).durability(100));
		setRegistryName("bow_in");
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					BowINEntity entityarrow = BowINEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
					...
					BowINRangedItemUsedProcedure.execute(world, x, y, z);
				}
			}
		}
	}
