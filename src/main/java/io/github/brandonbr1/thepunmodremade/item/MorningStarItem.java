...
import io.github.brandonbr1.thepunmodremade.procedures.MorningStarRightClickedInAirProcedure;
...
public class MorningStarItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		MorningStarRightClickedInAirProcedure.execute(world, x, y, z);
		return ar;
	}
}
