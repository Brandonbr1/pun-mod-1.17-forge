...
public class FeatherThrowItem extends Item {
	public FeatherThrowItem() {
		super(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).durability(1));
		setRegistryName("feather_throw");
	}
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				FeatherThrowEntity entityarrow = FeatherThrowEntity.shoot(world, entity, world.getRandom(), 1f, 3, 5);
